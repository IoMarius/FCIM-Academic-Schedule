$.fn.pcodedmenu = function( settings ) {
	...
	var PcodedMenu = {
		...
		HandleHorizontalMobileMenuToggle: function() {
			if (settings.themelayout === "horizontal"){
				$('.pcodedbrand-xs .menu-toggle a').on('click', function( ){
		...
		HandleNavbarPosition: function() {
				...
				case 'horizontal':
					if ( navposition == true){
						...
						$('#'+oid + ' .pcoded-navbar').attr("pcoded-navbar-position", ' ' );
						$('#'+oid + ' .pcoded-header').attr("pcoded-header-position", 'relative' );
		...
		HandleMenuOnClick: function() {
			...
			if (settings.themelayout === "vertical" ) {
				$('.sidebar_toggle a, .pcoded-overlay-box').on("click", function() {
		...
		Handlecomponetheight: function() {
			function setHeight() {
				...
				var lpanelH = WH - HH ;
				if (settings.themelayout === "horizontal" ) {
					$(".pcoded-main-container").css('min-height', contentHH);
				} else if (settings.themelayout === "vertical" ) {
					if ( contentVH >= lpanelH ){
						$(".pcoded-main-container").css('min-height', contentVH);
					}else {
						$(".pcoded-main-container").css('min-height', lpanelH);
					}
				} else {
					return false;
				}
