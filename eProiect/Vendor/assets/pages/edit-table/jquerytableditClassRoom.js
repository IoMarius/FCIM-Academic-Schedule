    ...
    $.fn.Tabledit = function(options) {
        ...
        var Edit = {
            ...
            submit: function(td) {
                 ...
                 var classRoomData = {
                      Id: id,
                      ClassroomName: $(td).parent('tr').find("input[name='Name']").val(),
                      Floor: $(td).parent('tr').find("input[name='Floor']").val(),
          
                 };

                 $.ajax({
                      url: '/Admin/EditClassRoomData',
                      type: 'POST',
            ...
            submit: function(td) {
                ...
                var id = $(td).closest('tr').attr('name');;
                 $.ajax({
                      ...
                      type: 'POST',
                      contentType: 'application/json',
                      data: JSON.stringify({ classRoomIdForDeleted: id }), // Trimitem obiectul JSON care conține ID-ul utilizatorului
                      dataType: "json",
                      success: function (response) {
                           console.log(response);
