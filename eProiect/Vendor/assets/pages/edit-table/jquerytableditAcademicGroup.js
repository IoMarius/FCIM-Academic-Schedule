     ...
     $.fn.Tabledit = function (options) {
          ...
          var Edit = {
               ...
               submit: function (td) {
                    ...
                    var editedAcedemicGroupData = {
                         Id: id,
                         Name: $(td).parent('tr').find("input[name='Name']").val(),
                         Year: $(td).parent('tr').find("input[name='ShortName']").val(),
                    };
          ...
          var Delete = {
               ...
               submit: function (td) {
                    ...
                    var id = $(td).closest('tr').attr('name');;
                    $.ajax({
                         url: '/Admin/DeleteAcademicGroup',
                         type: 'POST',
                         contentType: 'application/json',
                         data: JSON.stringify({ academicGroupIdForDeleted: id }), // Trimitem obiectul JSON care conține ID-ul utilizatorului
                         dataType: "json",
                         success: function (response) {
                              console.log(response);
