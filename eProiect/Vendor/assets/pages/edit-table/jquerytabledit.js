                    ...
                    toolbar: function () {
                         ...
                         if (settings.editButton || settings.deleteButton) {
                              ...
                              if (settings.editButton && settings.saveButton) {
                                   saveButton = '<button type="button" class="tabledit-save-button ' + settings.buttons.save.class + '" style="display: none; float: none;" id = "saveButton" >' + settings.buttons.save.html + '</button>';
                              }
